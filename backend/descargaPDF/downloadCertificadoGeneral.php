...
$pdf->MultiCell(160, 5, iconv('UTF-8', 'windows-1252//TRANSLIT',
    ...
    ', ha realizado y completado satisfactoriamente el proceso de inducción general, en el cual se abordaron los temas de misión, visión, valores, reglamento interno de trabajo, aspectos contractuales y Sistema de Gestión de Seguridad y Salud en el Trabajo (SG-SST).'
));
$pdf->SetXY(23, 170); 
$pdf->MultiCell(160, 5, iconv('UTF-8', 'windows-1252//TRANSLIT',
...
// Descargar el PDF
$pdf->Output('D', __DIR__ . '/certificado-induccionGeneral.pdf');
exit;
?>
