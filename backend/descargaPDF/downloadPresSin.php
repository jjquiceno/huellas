...
$pdf->MultiCell(160, 5, iconv('UTF-8', 'windows-1252//TRANSLIT',
    ...
    ' presto servicios profesionales a eta empresa como ' . $cargo['cargo'] . ' devengando unos honorarion mensuales de $' . $empleado['salario'] . ' en el periodo comprendido de ' . $empleado['fecha_ingreso'] . ' hasta ' . date('d/m/Y') . '.'
));
// $pdf->SetFont('Arial','B',12);
// $pdf->SetXY(23, 105); 
// $pdf->MultiCell(160, 5, iconv('UTF-8', 'windows-1252//TRANSLIT',
...
// Descargar el PDF
$pdf->Output('D', __DIR__ . '/certificado-prestacion.pdf');
exit;
?>
