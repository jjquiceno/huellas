    ...
    <section class="container">
        <div class="preliminar">
            <div id="tel-email">
                <div class="tel-email-int" data-aos="zoom-in" data-aos-duration="500">
                    ...
                    <p class="light">+57 123 456 78 90</p>
                </div>
                <div class="tel-email-int" data-aos="zoom-in" data-aos-duration="500">
                    <i class="fa-solid fa-envelope"></i>
                    <p><a href="" class="correo light">fundacionhuellasdelayer@gmail.com</a></p>
                </div>
            </div>
            <div class="pre-redes"> 
            ...
            <div class="menu">
                <nav>
                    <ul>
                        ...
                        <li><a class="header-link light" href="loginOptions.html">Iniciar Sesión</a></li>
                        ...
                        <div class="options">
                            <nav>
                                <ul class="menu-float-ul">
                                    ...
                                    <li><a class="header-link bold x1-5" href="loginOptions.html">Iniciar Sesión</a></li>
        ...
        <div class="home">
            <div class="home-texts">
                ...
                <br>
                <p class="black x2">VAS A TRABAJAR CON NOSOTROS</p>
                <br>
                <div class="separador"></div>
                <br>
                <P class="regular x1-5">REALIZA LA <span>INDUCCIÓN</span></P>
                <br>
                <div class="separador-corto"></div>
            </div>
        </div>
            ...
            <div class="form-padre">
                <div class="form-padre-info">
                    <div>
                        ...
                        <div class="separador"></div>
                        <br>
                        <p class="bold x3 WHITE">¡HAZ TU INDUCCIÓN!</p>
                        <br>
                        <div class="separador"></div>
                        <br>
                        <div class="separador-corto"></div>
